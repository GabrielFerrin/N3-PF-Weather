...
function Coordinates() {
  ...
  return (
    <div style={{ right: '0', transform: 'translateX(-24%)' }}
      ...
      <div onClick={useMyLocations}
        className="relative hover:text-[#555555] bg-[#3C47E9] hover:bg-[#E7E7EB] active:bg-[#b5b5bb] transition duration-300 bg-opacity-90">
        <input
          className="text-[16px] w-[100%] h-[48px] font-[600]"
          type="button" value="Use my location" />
        <div
          className="absolute z-55 top-[16px] right-10 h-4 w-4 hover:fill-[#555555]">
          <Location />
        </div>
      </div>
